<form id="mhamdy-testimonial-form" action="#" method="post" data-url="<?php echo admin_url('admin-ajax.php'); ?>">
    ...
    <input type="hidden" name="nonce" value="<?php echo wp_creat_nonce('testimomial-nonce'); ?>">
